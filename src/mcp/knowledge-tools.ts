...
function listDocs(): string {
  const sections = [
    ...
    '```bash',
    'reflexive [options] <app.js|app.py|main.go>',
    '',
    '# Common flags:',
    '--write          # Allow file modifications',
    '--shell          # Allow shell commands',
    '--debug          # Enable multi-language debugging',
    ...
    '',
    'Reflexive supports debugging Node.js, Python, Go, .NET, and Rust:',
    '',
    ...
    '| .NET | .cs | netcoredbg | See netcoredbg releases |',
    ...
    '```',
    '',
    'Debug tools: `debug_set_breakpoint`, `debug_remove_breakpoint`,',
    '`debug_resume`, `debug_step_over`, `debug_step_into`, `debug_step_out`,',
    '`debug_get_call_stack`, `debug_evaluate`, `debug_get_scope_variables`',
    '',
    'Breakpoints persist across restarts. Add prompts to breakpoints:',
    '```',
    '[debug_set_breakpoint: file="app.py", line=25, prompt="Analyze this"]',
    '```',
    '',
