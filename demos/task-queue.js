 ...
 * Task Queue Demo
 *
 * A task queue simulation with background worker processing.
 * Run with: npx reflexive demos/task-queue.js
 * Or:       npx reflexive --demo queue
 */
...
const server = http.createServer((req, res) => {
  ...
  if (url.pathname === '/metrics') {
    ...
    res.end(JSON.stringify({
      queue: { pending, processing, completed, failed, total: tasks.length },
      rates: {
